...
<head>
    ...
    <title>{{ config('app.name', 'So Pekocko') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('web.sauces.index.all') }}">Toutes les sauces</a>
                        </li>
                        @auth
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('web.sauces.index') }}">Mes sauces</a>
                            </li>
                        @endauth
                    </ul>
